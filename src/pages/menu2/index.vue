<template>
  <div>
    ...
    <div>
      <el-cascader class="input" :options="options" clearable></el-cascader>
      <el-select class="input" v-model="select.value" placeholder="请选择">
        <el-option
      ...
      <el-select class="input" v-model="select2.value" placeholder="请选择">
